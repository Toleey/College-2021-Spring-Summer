...
//        sql+=")";
    ...
    @Override
    public String getUserPasswordById(Connection conn, Integer id) {
        String sql = "SELECT userPassword FROM smbms_user WHERE id = " +id;
        ResultSet rst = BaseDao.executeQuery(conn,sql);
        String userPassword = "";
        try {
            if(rst.next()) {
    ...
    @Override
    public Integer updateUserPasswordById(Connection conn, Integer id, String password) {
        String sql = "UPDATE smbms_user SET userPassword = ? WHERE id = ? ";
        Integer line = BaseDao.executeUpdate(conn,sql,password,id);
        return line;
    }
