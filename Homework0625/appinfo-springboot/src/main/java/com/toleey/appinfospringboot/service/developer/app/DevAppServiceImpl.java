package com.toleey.appinfospringboot.service.developer.app;

import com.toleey.appinfospringboot.dao.developer.app.DevAppMapper;
...
public class DevAppServiceImpl implements DevAppService{
    ...
    public AppInfo findAnAppInfoByIdToUpdate(Integer id) {
        return devAppMapper.getAnAppInfoByIdToUpdate(id);
    }
    ...
    public List<AppVersion> findAppVersionByAppId(Integer appId ) {
        return devAppMapper.getAppVersionByAppId(appId);
    }
    ...
    public AppVersion findAnAppVersionById(Integer id) {
        return devAppMapper.getAnAppVersionById(id);
    }

    @Override
    public boolean updateAnAPKFileToNull(Integer id) {
        return devAppMapper.updateAnAPKFileToNull(id)>0;
    }

    @Override
    public boolean updateALogoPictureToNull(Integer id) {
        return devAppMapper.updateALogoPictureToNull(id)>0;
    }

    @Override
    public boolean updateAppInfoStatusLaunch(Integer id) {
        return devAppMapper.updateAppInfoStatusLaunch(id)>0;
    }

    @Override
    public boolean updateAppInfoStatusRemoval(Integer id) {
        return devAppMapper.updateAppInfoStatusRemoval(id)>0;
    }
