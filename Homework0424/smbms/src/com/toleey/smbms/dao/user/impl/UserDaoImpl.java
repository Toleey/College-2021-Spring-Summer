...
public class UserDaoImpl  implements UserDao {
    ...
    public Integer insertUser(Connection conn, User user) {
        String sql = "INSERT INTO smbms_user" +
                "(userCode,userName,userPassword,gender,birthday,phone,createdBy,creationDate,address,userRole,idPicPath) " +
                "VALUES (?,?,?,?,?,?,?,?,?,?,?) ";
...
//        sql+=")";
        ...
        Integer line = BaseDao.executeUpdate(conn,sql,
                ...
                user.getAddress(),user.getUserRole(),user.getIdPicPath());
        return line;
    }
