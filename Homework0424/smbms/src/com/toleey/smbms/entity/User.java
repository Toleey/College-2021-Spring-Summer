...
public class User {
    ...
    public User(Integer id, String userCode, String userName, String userPassword, String ruserPassword, Integer gender, Date birthday, Integer age, String phone, String address, Integer userRole, Integer createdBy, Timestamp creationDate, Integer modifyBy, Timestamp modifyDate, String idPicPath, String roleName) {
        this.id = id;
